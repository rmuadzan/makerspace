...
class Sarjana extends Public_Controller {
    ...
    public function index()
    {
        ...
        $data = $this->crud->gw($this->table, array('id_halaman' => 24))[0];
        
        $data = array(  'title'     => $data->{'nama_'.$this->lang},
                        'data'    => $data,
                        'isi'       => 'homepage/sarjana/view_#'.$this->lang);
    ...
    public function doktor()
    {
        ...
        $data = $this->crud->gw($this->table, array('id_halaman' => 26))[0];
    ...
    public function magister()
    {
        ...
        $data = $this->crud->gw($this->table, array('id_halaman' => 25))[0];
