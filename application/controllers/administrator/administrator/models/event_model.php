...
class event_model{
	...
	public function insertAkreditasi($judul_id,$keterangan){
		// $nama_file 		= "coba";
		// $standar_1		= 1;
		// $standar_2		= 1;
		// $standar_3		= 1;
		...
		$query = $this->db->prepare("INSERT INTO `dokumen_akreditasi` SET 
																...
																");
		$query->bindParam(':nama_dokumen',$judul_id,PDO::PARAM_STR);
		$query->bindParam(':keterangan_dokumen',$keterangan,PDO::PARAM_STR);
		// $query->bindValue(':nama_file',$nama_file);
		// $query->bindValue(':standar_1',$standar_1);
		// $query->bindValue(':standar_2',$standar_2);
		// $query->bindValue(':standar_3',$standar_3);
		// $query->bindValue(':standar_4',$standar_4);
		// $query->bindValue(':standar_5',$standar_5);
		// $query->bindValue(':standar_6',$standar_6);
		// $query->bindValue(':standar_7',$standar_7);
		try{
			$query->execute();
			die($query);
			return true;
