...
class jurusan_model{
	...
	public function getJurusanByJurusan($id){

		$query = $this->db->prepare("select * from jurusan where jurusan = :id "); 
		$query->bindValue(':id',$id);
	...
	public function getJurusanByDomain($id){

		$query = $this->db->prepare("select * from jurusan where subdomain = :id "); 
		$query->bindValue(':id',$id);
