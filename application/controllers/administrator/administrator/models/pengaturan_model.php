...
class pengaturan_model{
	...
	public function getPengaturanByNama($id){

		$query = $this->db->prepare("select * from pengaturan where nama_website = :id");
		$query->bindParam(':id',$id,PDO::PARAM_INT);
		try{
			$query->execute();
		}catch(PDOException $e){
	...
	public function updatePengaturan($id_nama_website,$nama_website,$nama_website_en,$icon,$alamat,$telepon,$fax,$email,$footer){
