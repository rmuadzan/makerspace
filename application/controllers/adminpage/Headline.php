...
class Headline extends Admin_Controller {
    ...
    public function tambah()
    {
        ...
        // $valid->set_rules('judul_en', 'judul (Inggris)', 'trim|strip_tags|htmlspecialchars');
        ...
        else
        {
            ...
            if ($cfoto) $cfoto->default_width = 1080;

            $gambar = upload_image(array('foto', $cfoto), 'tambah', 'headline', '', $data, TRUE);
