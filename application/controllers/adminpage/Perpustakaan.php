...
class Perpustakaan extends Admin_Controller {
    ...
    public function index()
    {
        ...
        $buku = $this->crud->ga('perpustakaan');
        $data = array(  'title'         => 'Daftar Perpustakaan',
                        'buku'          => $buku,
                        'jml'           => jml_nav(),
                        'isi'           => 'adminpage/perpustakaan/list');
    ...
    public function tambah()
    {
        ...
        $data = array(  'title'         => 'Tambah File',
                        'isi'           => 'adminpage/perpustakaan/tambah');
        ...
        else
        {
            ...
            $file = upload_document('file', 'tambah', 'perpustakaan', '', $data, TRUE);

            // Masuk ke database
            if ($file !== FALSE)
            {
                $input = $this->input->post(NULL,'', FALSE);
                $data = array(  'nama_file_id'  => $input['nama_file_id'],
