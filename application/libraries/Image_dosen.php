...
class Image_dosen {
    ...
    public function load_manager($field = 'img', $img = '', $max_width_cropzoom = 277, $max_height_cropzoom = 150)
    {
        ...
        <link href="'.dosen_assets().'plugins/cropzoom/jquery.cropzoom.css" rel="Stylesheet" type="text/css" />
        <script type="text/javascript" src="'.dosen_assets().'plugins/cropzoom/jquery.cropzoom.js"></script>
        ';
