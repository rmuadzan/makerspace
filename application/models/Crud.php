...
class Crud extends CI_Model {
    ...
    public function gjw($t,$tj,$c,$w,$jj = 'LEFT'){return $this->db->join($tj,$tj.'.'.$c.' = '.$t.'.'.$c,$jj)->where($w)->get($t)->result();}
    public function gjwo($t,$tj,$c,$w,$o,$jj = 'LEFT'){return $this->db->join($tj,$tj.'.'.$c.' = '.$t.'.'.$c,$jj)->where($w)->order_by($o)->get($t)->result();}
    public function cjw($t,$tj,$c,$w,$jj = 'LEFT'){return $this->db->join($tj,$tj.'.'.$c.' = '.$t.'.'.$c,$jj)->where($w)->get($t)->num_rows();}
    ...
    public function cwgroup5($t,$w){return $this->db->where($w)->limit(5,0)->group_by('tahun')->get($t)->result();}
}
