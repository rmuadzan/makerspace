        ...
        <div id="sidebar" class="sidebar sidebar-grid">
            <div data-scrollbar="true" data-height="100%">
                <ul class="nav">
                    ...
                    <!-- <li class="has-sub <?=($modul == 'skripsi' ? 'active' : '')?>">
                        <a href="javascript:;">
                            <span>Skripsi</span>
                            <b class="caret pull-right"></b>
                        ...
                        <ul class="sub-menu">
                            <li class="<?=(($modul == 'skripsi' AND ($method == '' OR $method == 'edit')) ? 'active' : '')?>">
                                <a href="<?=admin_url('skripsi')?>">
                                    <span>Daftar Skripsi</span>
                                </a>
                            </li>
                            <li class="<?=(($modul == 'skripsi' AND $method == 'tambah') ? 'active' : '')?>">
                                <a href="<?=admin_url('skripsi/tambah')?>">
                    ...
                    <li class="has-sub <?=($modul == 'penelitian' ? 'active' : '')?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="<?=(($modul == 'penelitian' AND $method == 'pengabdian') ? 'active' : '')?>">
                                <a href="<?=admin_url('penelitian/pengabdian')?>">
                    ...
                    <!-- <li class="has-sub <?=($modul == 'buku' ? 'active' : '')?>">
                        <a href="javascript:;">
                            <span>Buku</span>
                            <b class="caret pull-right"></b>
                        ...
                        <ul class="sub-menu">
                            <li class="<?=(($modul == 'buku' AND ($method == '' OR $method == 'edit')) ? 'active' : '')?>">
                                <a href="<?=admin_url('buku')?>">
                                    <span>Daftar Buku</span>
                                </a>
                            </li>
                            <li class="<?=(($modul == 'buku' AND $method == 'tambah') ? 'active' : '')?>">
                                <a href="<?=admin_url('buku/tambah')?>">
                                    <span>Tambah Buku</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub <?=($modul == 'haki' ? 'active' : '')?>">
                        <a href="javascript:;">
                            <span>HAKI</span>
                            <b class="caret pull-right"></b>
                        ...
                        <ul class="sub-menu">
                            <li class="<?=(($modul == 'haki' AND ($method == '' OR $method == 'edit')) ? 'active' : '')?>">
                                <a href="<?=admin_url('haki')?>">
                                    <span>Daftar HAKI</span>
                                </a>
                            </li>
                            <li class="<?=(($modul == 'haki' AND $method == 'tambah') ? 'active' : '')?>">
                                <a href="<?=admin_url('haki/tambah')?>">
                                    <span>Tambah HAKI</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub <?=($modul == 'mata_kuliah' ? 'active' : '')?>">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu">
                            <li class="<?=(($modul == 'mata_kuliah' AND ($method == '' OR $method == 'edit')) ? 'active' : '')?>">
                                <a href="<?=admin_url('mata_kuliah')?>">
                                    <span>Daftar Mata Kuliah</span>
                                </a>
                            </li>
                            <li class="<?=(($modul == 'mata_kuliah' AND $method == 'tambah') ? 'active' : '')?>">
                                <a href="<?=admin_url('mata_kuliah/tambah')?>">
