                ...
                <div class="panel panel-inverse" data-sortable-id="index-1">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            ...
                            <div class="col-sm-12 col-lg-12 col-md-12">
                                <?=form_open_multipart(admin_url('grafik/edit/'.$data->id_grafik), array('id' => 'form1'))?>
                                <div class="col-md-8">
                                    <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <img class="img-thumbnail img-responsive" id="uploadgambar" src="<?=upload_url('grafik').(empty($data->photo) ? 'no_image.png' : $data->photo)?>" width="100%" alt="Upload Gambar" />
                                        </div>
                                    </div>
                                </div>
                                <?=form_close()?>
