                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            <div class="row-fluid">
                                <div class="col-sm-12">
                                    <a class="btn btn-primary insert" href="<?=admin_url('informasi/tambah')?>"><i class="fa fa-plus"></i> Tambah</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php $i = $offset + 1; foreach ($informasi as $data): ?>
                                        <tr>
                                            <td class="text-center"><?=$i?></td>
                                            <td class="text-center"><img src="<?=upload_url('informasi/thumbs').(empty($data->gambar) ? 'no_image.png' : $data->gambar)?>" height="70" /></td>
                                            <td><?=$data->judul?></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="javascript:;" onclick="hapus_data('informasi', '<?=$data->id_informasi?>')" class="btn btn-danger btn-xs" title="Hapus"><i class="fa fa-trash-o"></i> Hapus</a>
                                            </td>
                                            <?php } else { ?>
