                ...
                <div class="panel panel-inverse" data-sortable-id="index-1">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            ...
                            <div class="col-sm-12 col-lg-12 col-md-12">
                                <?=form_open_multipart(admin_url('informasi/tambah'), array('id' => 'form1'))?>
                                    <div class="col-md-8">
                                        <div class="form-group form-group-lg">
                                            <label class="control-label">Judul Informasi (Bahasa Indonesia)<i class="req">*</i></label>
                                            <input type="text" name="judul" id="judul" class="form-control" placeholder="Judul Informasi (Bahasa Indonesia)" value="<?=set_value('judul')?>" onkeyup="cek_judul_id()"/>
                                            <div id="preview_id">
                                         ...
                                         <div class="form-group form-group-lg">
                                            <label class="control-label">Judul Informasi (English)</label>
                                            <input type="text" name="judul_en" id="judul_en" class="form-control" placeholder="Judul Informasi (English)" value="<?=set_value('judul_en')?>" onkeyup="cek_judul_en()"/>
                                            <div id="preview_en">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" name="isi" class="form-control ckeditor" placeholder="Tuliskan isi blog di sini." rows="7"><?=set_value('isi')?></textarea>
                                            <?=form_error('isi')?>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Isi Informasi (English) <i class="req">*</i></label>
                                            <textarea id="editor2" name="isi_en" class="form-control ckeditor" placeholder="Tuliskan isi blog di sini." rows="7"><?=set_value('isi_en')?></textarea>
                                            <?=form_error('isi_en')?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img class="img-thumbnail img-responsive" id="image-preview" src="<?=upload_url('informasi/thumbs')?>no_image.png" width="100%" alt="Upload Gambar" />
                                        </div>
                                    </div>
                                <?=form_close()?>
                            </div>
