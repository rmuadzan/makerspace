                ...
                <div class="panel panel-inverse" data-sortable-id="index-1">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            ...
                            <div class="col-sm-12 col-lg-12 col-md-12">
                                <?=form_open_multipart(admin_url('laboratorium/edit/'.$data->id_lab), array('id' => 'form1'))?>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <input type="text" name="nama_id" class="form-control" placeholder="Laboratorium (Indonesia)" value="<?=set_value('nama_id', $data->lab_id)?>" required />
                                        <?=form_error('nama_id')?>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        <label class="control-label">Nama Laboratorium (English) <i class="req">*</i></label>
                                        <input type="text" name="nama_en" class="form-control" placeholder="Laboratorium (English)" value="<?=set_value('nama_en', $data->lab_en)?>" required />
                                        <?=form_error('nama_en')?>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        <label class="control-label">Ketua Laboratorium <i class="req">*</i></label>
                                        <select name="ketua" class="form-control">
														<option value="<?=set_value('ketua', $data->ketua_lab)?>" >
															<?=$ketua->nama_dosen?>
														</option>
...
<?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi_id" class="form-control ckeditor" placeholder="Tuliskan isi halaman di sini (dalam Bahasa Indonesia)." rows="7"><?=set_value('deskripsi_en', $data->isi_id)?></textarea>
                                        <?=form_error('deskripsi_id')?>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Deskripsi (English)</label>
                                        <textarea name="deskripsi_en" class="form-control ckeditor" placeholder="Tuliskan isi halaman di sini (dalam Bahasa Inggris)." rows="7"><?=set_value('deskripsi_en', $data->isi_en)?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img class="img-thumbnail img-responsive" id="image-preview" src="<?=upload_url('lab').(empty($data->foto_lab) ? 'kampus.jpg' : $data->foto_lab)?>" width="100%" alt="Upload Gambar" />
                                        </div>
                                <?=form_close()?>
                            </div>
                        </div>
