    ...
    <div id="page-container" class="fade">
        <div class="login login-v2" data-pageload-addclass="animated flipInX">
            ...
            <div class="login-content">
                <?=form_open(login_url('forget'), array('class' => 'margin-bottom-0'))?>
                    ...
                    <div class="form-group m-b-20">
                        <input type="email" name="email" class="form-control input-lg" placeholder="Ketik Alamat E-mail Anda" value="<?=set_value('email')?>" required />
                    </div>
                    <div class="login-buttons">
                        <button type="submit" name="submit" class="btn btn-success btn-block btn-lg">Reset Password</button>
                    </div>
                    <div class="m-t-20">
                        <a href="<?=login_url()?>">Kembali ke Halaman Login</a>
                    </div>
                <?=form_close()?>
            </div>
        </div>
