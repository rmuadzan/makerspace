                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            ...
                            <div class="table-responsive">
                                <?=form_open_multipart(admin_url('mata_kuliah/tambah/'), array('id' => 'form1'))?>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sks" class="form-control" value="<?=set_value('sks')?>" />
                                                <?=form_error('sks')?>
                                            </div>
                                        </div>
                                         <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="jenis" class="form-control">
                                                    ...
                                                    <option value="<?=$status[0]?>"<?=set_select('jenis', $status[0])?>>Wajib</option>
                                                    <option value="<?=$status[1]?>"<?=set_select('jenis', $status[1])?>>Wajib Laboratorium</option>
                                                    <option value="<?=$status[2]?>"<?=set_select('jenis', $status[2])?>>Pilihan Laboratorium</option>
                                                </select>
                                                <?=form_error('jenis')?>
                                            </div>
                                        </div>
