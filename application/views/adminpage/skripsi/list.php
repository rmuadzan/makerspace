                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            <div class="row-fluid">
                                <div class="col-sm-12">
                                    <a class="btn btn-primary insert" href="<?=admin_url('skripsi/tambah')?>"><i class="fa fa-plus"></i> Tambah</a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="skripsi-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Mahasiswa (Stambuk) <span></span></th>
                                            <!-- <th class="text-center">Pembimbing <span></span></th> -->
                                            <th class="text-center">Tanggal Proposal <span></span></th>
                                            <th class="text-center">Lama Pengerjaan <span></span></th>
                                            <th class="text-center">Tanggal Ujian <span></span></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$data->nama_mahasiswa.' ('.$data->nim.')'?></td>
                                            <!-- <td><?=$data->pembimbing_1.' & '.$data->pembimbing_2?></td> -->
                                            <td class="text-center"><?=tgl_indo($data->tanggal_proposal)?></td>
                                            <td class="text-center">
                                                <?php if ($data->tanggal != NULL){ ?>
                                                    LULUS
                                                <?php } else{ 
                                                    $date1 = date_create(date("Y-m-d"));
                                                    $date2 = date_create($data->tanggal_proposal);

                                                    $date = date_diff($date1, $date2); 
                                                ?>
                                                    <?=$date->y." Tahun ".$date->m." Bulan ".$date->d." Hari"?>
                                            ...
                                            <td class="text-center">
                                                <?php if ($data->tanggal == NULL){ ?>
                                                    <a href="javascript:void(0);" class="btn btn-info ujian" data-nama="<?=$data->nama_mahasiswa?>" data-nim="<?=$data->nim?>" data-judul="<?=$data->nama_file_id?>">Tanggal Ujian</a>
                                                <?php } else{ ?>
