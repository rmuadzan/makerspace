                ...
                <div class="panel panel-inverse" data-sortable-id="index-1">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            ...
                            <div class="col-sm-12 col-lg-12 col-md-12">
                                <?=form_open_multipart(admin_url('staff/tambah'), array('id' => 'form1'))?>
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <input type="text" name="jabatan" class="form-control" placeholder="Jabatan Staff" value="<?=set_value('jabatan')?>" required />
                                        <?=form_error('jabatan')?>
                                    </div>
                                    <div class="form-group">
                                            <label class="control-label">Upload Gambar Staff</label>
                                            <input type="file" class="form-control" name="nama_file" onchange="readURL(this);" accept="image/*" />
                                            <?=(isset($error_upload) ? $error_upload : '')?>
                                    </div>
                                    <div class="form-group">
                                            <label class="control-label">Tampilan Gambar</label>
                                            <img class="img-thumbnail img-responsive" id="uploadgambar" src="<?=upload_url('staff/thumbs')?>no_image.png" width="100%" alt="Upload Gambar" />
                                    </div>
                                <?=form_close()?>
                            </div>
                        </div>
