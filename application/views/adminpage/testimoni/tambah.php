                ...
                <div class="panel panel-inverse" data-sortable-id="index-1">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-lg-12 col-md-12">
                            ...
                            <div class="col-sm-12 col-lg-12 col-md-12">
                                <?=form_open_multipart(admin_url('testimoni/tambah/'), array('id' => 'form1'))?>
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judul" class="form-control" placeholder="Judul Testimoni"/>
                                            <?=form_error('judul')?>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Deskripsi Testimoni</label>
                                            <textarea id="ckeditor" name="deskripsi" class="form-control ckeditor" placeholder="Tuliskan deskripsi portofolio di sini." rows="7"></textarea>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="foto" class="form-control" placeholder="Foto User" onchange="readURL(this);" accept="image/*" />
