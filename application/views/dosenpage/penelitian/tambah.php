					...
					<div class="m-content">
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="m-portlet">
									<!--begin::Form-->
									<?=form_open_multipart(dosen_url('penelitian/tambah'), array('id' => 'form1'))?>
											...
											<div class="m-portlet__body">
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<input type="text" name="judul_id" class="form-control m-input" placeholder="Masukkan judul penelitian dalam bahasa indonesia" value="<?=set_value('judul_id')?>" required>
														<?=form_error('judul_id')?>
													</div>
													<div class="col-lg-6">
														<label class="col-form-label">
														...
														<input type="text" name="judul_en" class="form-control m-input" placeholder="Masukkan judul penelitian dalam bahasa inggris" value="<?=set_value('judul_en')?>" required>
														<?=form_error('judul_en')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
	...
	<?php } ?>
													...
													<div class="col-lg-6">
														...
														<input type="text" name="tahun" class="form-control m-input" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?=set_value('tahun')?>" placeholder="Masukkan tahun penelitian">
														<?=form_error('tahun')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<input name="ketua" type="text" class="form-control m-input" value="<?=set_value('ketua', $ketua->nama_dosen)?>">
														<?=form_error('ketua')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
	...
	<?php } ?>
												...
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<textarea class="summernote" name="abstrak_id" id=""><?=set_value('abstrak_id')?></textarea>
													...
													<div class="col-lg-6">
														...
														<textarea class="summernote" name="abstrak_en" id=""><?=set_value('abstrak_en')?></textarea>
												...
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<textarea class="summernote" name="tujuan_id" id=""><?=set_value('tujuan_id')?></textarea>
													...
													<div class="col-lg-6">
														...
														<textarea class="summernote" name="tujuan_en" id=""><?=set_value('tujuan_en')?></textarea>
												...
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<textarea class="summernote" name="manfaat_id" id=""><?=set_value('manfaat_id')?></textarea>
													...
													<div class="col-lg-6">
														...
														<textarea class="summernote" name="manfaat_en" id=""><?=set_value('manfaat_en')?></textarea>
												...
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<textarea class="summernote" name="hasil_id" id=""><?=set_value('hasil_id')?></textarea>
														<?=form_error('hasil_id')?>
													</div>
													<div class="col-lg-6">
														<label class="col-form-label">
														...
														<textarea class="summernote" name="hasil_en" id=""><?=set_value('hasil_en')?></textarea>
														<?=form_error('hasil_en')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<input type="text" name="grant" class="form-control m-input" placeholder="Masukkan nama grant" value="<?=set_value('grant')?>">
														<?=form_error('grant')?>
													</div>
													<div class="col-lg-6">
														<label class="col-form-label">
														...
														<input type="text" name="sumber_dana" class="form-control m-input" placeholder="Masukkan sumber dana" value="<?=set_value('sumber_dana')?>" required>
												...
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<input type="text" name="kata_kunci" class="form-control m-input" placeholder="Masukkan kata kunci" value="<?=set_value('kata_kunci')?>">
													...
													<div class="col-lg-6">
														...
														<input type="text" name="durasi" class="form-control m-input" placeholder="Masukkan durasi penelitian" value="<?=set_value('durasi')?>">
														<?=form_error('durasi')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-4">
															...
															<input type="file" name="nama_file" class="form-control m-input">
