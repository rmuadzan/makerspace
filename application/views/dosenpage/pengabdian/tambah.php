					...
					<div class="m-content">
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="m-portlet">
									<!--begin::Form-->
									<?=form_open_multipart(dosen_url('pengabdian/tambah'), array('id' => 'form1'))?>
											...
											<div class="m-portlet__body">
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<input type="text" name="judul_id" class="form-control m-input" placeholder="Masukkan judul pengabdian dalam bahasa indoneisa" value="<?=set_value('judul_id')?>" required>
														<?=form_error('judul_id')?>
													</div>
													<div class="col-lg-6">
														<label class="col-form-label">
														...
														<input type="text" name="judul_en" class="form-control m-input" placeholder="Masukkan judul pengabdian bahasa inggris" value="<?=set_value('judul_en')?>" required>
														<?=form_error('judul_en')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
													...
													<div class="col-lg-6">
														...
														<input type="text" name="tahun" class="form-control m-input" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Masukkan tahun pengabdian" value="<?=set_value('tahun')?>">
														<?=form_error('tahun')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
													<div class="col-lg-6">
														...
														<input type="text" name="ketua" class="form-control m-input" placeholder="Ketua" value="<?=set_value('ketua', $ketua->nama_dosen)?>" required>
														<?=form_error('ketua')?>
													</div>
												</div>
												<div class="form-group m-form__group row">
