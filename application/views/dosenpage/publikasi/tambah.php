				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
							<div class="row">
								<div class="col-lg-12">
									<!--begin::Form Publikasi-->
									<div class="m-portlet">
										<!--begin::Form-->
										<?=form_open_multipart(dosen_url('publikasi/tambah'), array('id' => 'form1'))?>
												...
												<div class="m-portlet__body">
													<div class="form-group m-form__group row">
														<div class="col-lg-6">
															...
															<input type="text" name="judul_id" class="form-control m-input" placeholder="Masukkan judul artikel dalam bahasa indonesia" value="<?=set_value('judul_id')?>" required>
															<?=form_error('judul_id')?>
														</div>
														<div class="col-lg-6">
															<label class="col-form-label">
															...
															<input type="text" name="judul_en" class="form-control m-input" placeholder="Masukkan judul artikel dalam bahasa inggris" value="<?=set_value('judul_en')?>" required>
															<?=form_error('judul_en')?>
														</div>
													</div>
													<div class="form-group m-form__group row">
														<div class="col-lg-6">
															...
															<input type="text" name="deskripsi_id" class="form-control m-input" placeholder="Masukkan nama pertemuan dalam bahasa indonesia" value="<?=set_value('deskripsi_id')?>" required>
														...
														<div class="col-lg-6">
															...
															<input type="text" name="deskripsi_en" class="form-control m-input" placeholder="Masukkan nama pertemuan dalam bahasa inggris" value="<?=set_value('deskripsi_en')?>" required>
	...
	<?php } ?>
													...
													<div class="form-group m-form__group row">
														<div class="col-lg-6">
																...
																<input type="file" name="nama_file" class="form-control m-input" accept=".pdf">
