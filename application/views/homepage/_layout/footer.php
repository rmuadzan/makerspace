<!-- Footer section -->
		...
		<div class="container footer-top">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 footer-widget">
					...
					<div class="dobule-link">
						<ul>
							<li style="background-color: white; margin: 7px 2px;"><img class="img-partner" src="https://sapto.banpt.or.id/images/ban-pt.png"></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-6 col-lg-3 footer-widget">
    ...
    <script src="<?=home_assets()?>js/move-top.js"></script>
    <script src="<?=home_assets()?>js/easing.js"></script>
    <script src="<?=home_assets()?>js/responsive-slides.min.js"></script>
    <script src="<?=home_assets()?>js/skdslider.min,js"></script>
