	...
	<div  class="sticky">
		<header class="header-section ">
			<div class="container">
				<!-- logo -->
				<a href="<?=site_url()?>" class="site-logo-en"><img src="<?=home_assets()?>img/infor-logo-en.png" alt=""></a>
				...
				<!--<div class="header-info">
					...
					<div class="hf-item">
						...
						<p><span>Find us:</span><?=$pengaturan->alamat_id?></p>
					</div>
				</div>-->
			</div>
		</header>
	        ...
	        foreach ($parent as $key1 => $value1) {
	            if (sizeof($value1) == 1) { ?>
	                <li class="" data-id="<?=$value1['id']?>">
	                    <a href="<?=($this->crud->gda('halaman', array('id_halaman' => $value1['id']))['link_en'] == '#' ? '' : site_url()).(($this->crud->gda('halaman', array('id_halaman' => $value1['id']))['atribut']) != 'default' ? (($this->crud->gda('halaman', array('id_halaman' => $value1['id']))['tipe']) == 'Lab' ? ('lab/') : ('pages/')) : (($this->crud->gda('halaman', array('id_halaman' => $value1['id']))['tipe']) == 'akademik' ? ('academic/') : (''))).($this->crud->gda('halaman', array('id_halaman' => $value1['id']))['link_en'])?>"><?=($this->crud->gda('halaman', array('id_halaman' => $value1['id']))['nama_en'])?></a>
	                </li>
	            <?php } else { ?>
	                ...
	                foreach ($value1['children'] as $key2 => $value2) {
	                    if (sizeof($value2) == 1) { ?>
	                        <li class="" data-id="<?=$value2['id']?>">
	                            <a href="<?=($this->crud->gda('halaman', array('id_halaman' => $value2['id']))['link_en'] == '#' ? '' : site_url()).(($this->crud->gda('halaman', array('id_halaman' => $value2['id']))['atribut']) != 'default' ? (($this->crud->gda('halaman', array('id_halaman' => $value2['id']))['tipe']) == 'Lab' ? ('lab/') : ('pages/')) : (($this->crud->gda('halaman', array('id_halaman' => $value2['id']))['tipe']) == 'akademik' ? ('academic/') : (''))).($this->crud->gda('halaman', array('id_halaman' => $value2['id']))['link_en'])?>"><?=($this->crud->gda('halaman', array('id_halaman' => $value2['id']))['nama_en'])?></a>
	                        </li>
	                    <?php } else { ?>
	                        ...
	                        foreach ($value2['children'] as $key3 => $value3) {
	                            if (sizeof($value3) == 1) { ?>
	                                <li class="" data-id="<?=$value3['id']?>">
	                                    <a href="<?=($this->crud->gda('halaman', array('id_halaman' => $value3['id']))['link_en'] == '#' ? '' : site_url()).(($this->crud->gda('halaman', array('id_halaman' => $value3['id']))['atribut']) != 'default' ? (($this->crud->gda('halaman', array('id_halaman' => $value3['id']))['tipe']) == 'Lab' ? ('lab/') : ('pages/')) : (($this->crud->gda('halaman', array('id_halaman' => $value3['id']))['tipe']) == 'akademik' ? ('academic/') : (''))).($this->crud->gda('halaman', array('id_halaman' => $value3['id']))['link_en'])?>"><?=($this->crud->gda('halaman', array('id_halaman' => $value3['id']))['nama_en'])?></a>
	                                </li>
	                            <?php } else { ?>
	                                    ...
	                                    <?php
	                                        foreach ($value4['children'] as $key5 => $value5) { ?>
	                                                <li class="" data-id="<?=$value5['id']?>">
	                                                    <a href="<?=($this->crud->gda('halaman', array('id_halaman' => $value5['id']))['link_en'] == '#' ? '' : site_url()).(($this->crud->gda('halaman', array('id_halaman' => $value5['id']))['atribut']) != 'default' ? (($this->crud->gda('halaman', array('id_halaman' => $value5['id']))['tipe']) == 'Lab' ? ('lab/') : ('pages/')) : (($this->crud->gda('halaman', array('id_halaman' => $value5['id']))['tipe']) == 'akademik' ? ('academic/') : (''))).($this->crud->gda('halaman', array('id_halaman' => $value5['id']))['link_en'])?>"><?=($this->crud->gda('halaman', array('id_halaman' => $value5['id']))['nama_en'])?></a>
	                                                </li>
	                                        <?php } ?>
	                                            </ul>
	                                        </li>
